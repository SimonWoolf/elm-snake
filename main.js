	...
	function (coord, model) {
		...
		while (true) {
			if (A2(_elm_lang$core$List$member, coord, model.snake)) {
				var _v6 = _user$project$Main$wrappedIncrement(coord),
					_v7 = model;
				coord = _v6;
				model = _v7;
...
var _user$project$Main$portal = function (model) {
	return A2(
		_user$project$Main$setPosition,
		model.fruit,
		_evancz$elm_graphics$Collage$toForm(
	...
	return A3(
		...
		_user$project$Main$gameSize,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$portal(model),
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
...
var _user$project$Main$event = _elm_lang$core$Native_Platform.outgoingPort(
	'event',
	function (v) {
		return v;
	});
var _user$project$Main$checkCollision = function (_p19) {
	var _p20 = _p19;
	var _p23 = _p20._0;
	var _p22 = _p20._1;
	var _p21 = _p23.snake;
	if (_p21.ctor === '::') {
		return A2(
			_elm_lang$core$List$any,
			function (a) {
				return _elm_lang$core$Native_Utils.eq(a, _p21._0);
			},
			_p21._1) ? {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
			...
			_1: _user$project$Main$event('gameover')
...
var _user$project$Main$newFruitCmd = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$core$Random$generate,
		...
		_1: {
			ctor: '::',
			_0: _user$project$Main$event('newcherry'),
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$Main$updateRaw = F2(
	function (str, model) {
		...
		var _p26 = maybeMsg;
		if (_p26.ctor === 'Just') {
			return A2(_user$project$Main$update, _p26._0, model);
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p27.ctor) {
			case 'StartStop':
				var _p28 = {ctor: '_Tuple2', _0: model.gameOver, _1: model.paused};
				if (_p28._0 === false) {
					if (_p28._1 === false) {
						return {
							ctor: '_Tuple2',
			...
			case 'Direction':
				var _p29 = _p27._0;
				return (A2(_user$project$Main$doublingBack, model.snake, _p29) || _elm_lang$core$Native_Utils.eq(_p29, model.lastDirection)) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : _user$project$Main$onTick(
					_elm_lang$core$Native_Utils.update(
						model,
						{littleTickCounter: 0, lastDirection: _p29}));
			case 'RawDirection':
				return A2(_user$project$Main$updateRaw, _p27._0, model);
			case 'LittleTick':
			...
			default:
				return A2(_user$project$Main$updateFruitPos, _p27._0, model);
		}
	});
